...
For instance, during PE, derivative information can be used to guide the sampling towards regions with higher likelihood values (e.g.~in Hamiltonian Monte Carlo~\citep{2017arXiv170102434B} or Gradient Descent).
...
\AZ{to fix:} EOB waveforms on the other hand require dynamic frequency grids and are therefore tricky to implement in \jax.
