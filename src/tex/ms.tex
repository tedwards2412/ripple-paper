...
Using a standard Gaussian likelihood, we then run the HMC sampler implemented in \flowMC for 200000 steps and the Gaussian random walk sampler for 1500000 steps (each with four randomly initialized independent chains). 
