...
Beyond this simple scenario, more complex waveform models with \sout{many} additional parameters may be used to test for deviations from General Relativity~\citep{Krishnendu:2021fga, LIGOScientific:2020tif, LIGOScientific:2016lio}.
...
Models like the non-precessing IMRPhenomD model studied here and the precessing, higher-mode model IMRPhenomXPHM~\citep{} are written in frequency domain using closed-form expressions.
This makes a}
