...
\end{equation}
Note that here we have separated out the intrinsic ($\phi$) and extrinsic ($\Xi$) variables as well as introducing the detector projection functions for the plus and cross polarizations as $F^k_+$ and $F^k_\times$ respectively.
